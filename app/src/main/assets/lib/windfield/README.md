...
- [Documentation](#documentation)
  - [World](#world)
      - [`.newWorld(xg, yg, sleep)`](#newworldxg-yg-sleep)
      - [`:update(dt)`](#updatedt)
      - [`:draw(alpha)`](#drawalpha)
      - [`:destroy()`](#destroy)
      - [`:addCollisionClass(collision_class_name, collision_class)`](#addcollisionclasscollision_class_name-collision_class)
      - [`:newCircleCollider(x, y, r)`](#newcirclecolliderx-y-r)
      - [`:newRectangleCollider(x, y, w, h)`](#newrectanglecolliderx-y-w-h)
      - [`:newBSGRectangleCollider(x, y, w, h, corner_cut_size)`](#newbsgrectanglecolliderx-y-w-h-corner_cut_size)
      - [`:newPolygonCollider(vertices)`](#newpolygoncollidervertices)
      - [`:newLineCollider(x1, y1, x2, y2)`](#newlinecolliderx1-y1-x2-y2)
      - [`:newChainCollider(vertices, loop)`](#newchaincollidervertices-loop)
      - [`:queryCircleArea(x, y, r, collision_class_names)`](#querycircleareax-y-r-collision_class_names)
      - [`:queryRectangleArea(x, y, w, h, collision_class_names)`](#queryrectangleareax-y-w-h-collision_class_names)
      - [`:queryPolygonArea(vertices, collision_class_names)`](#querypolygonareavertices-collision_class_names)
      - [`:queryLine(x1, y1, x2, y2, collision_class_names)`](#querylinex1-y1-x2-y2-collision_class_names)
      - [`:addJoint(joint_type, ...)`](#addjointjoint_type-)
      - [`:removeJoint(joint)`](#removejointjoint)
      - [`:setExplicitCollisionEvents(value)`](#setexplicitcollisioneventsvalue)
      - [`:setQueryDebugDrawing(value)`](#setquerydebugdrawingvalue)
  - [Collider](#collider)
      - [`:destroy()`](#destroy-1)
      - [`:setCollisionClass(collision_class_name)`](#setcollisionclasscollision_class_name)
      - [`:enter(other_collision_class_name)`](#enterother_collision_class_name)
      - [`:getEnterCollisionData(other_collision_class_name)`](#getentercollisiondataother_collision_class_name)
      - [`:exit(other_collision_class_name)`](#exitother_collision_class_name)
      - [`:getExitCollisionData(other_collision_class_name)`](#getexitcollisiondataother_collision_class_name)
      - [`:stay(other_collision_class_name)`](#stayother_collision_class_name)
      - [`:getStayCollisionData(other_collision_class_name)`](#getstaycollisiondataother_collision_class_name)
      - [`:setPreSolve(callback)`](#setpresolvecallback)
      - [`:setPostSolve(callback)`](#setpostsolvecallback)
      - [`:addShape(shape_name, shape_type, ...)`](#addshapeshape_name-shape_type-)
      - [`:removeShape(shape_name)`](#removeshapeshape_name)
      - [`:setObject(object)`](#setobjectobject)
      - [`:getObject()`](#getobject)
- [LICENSE](#license)
